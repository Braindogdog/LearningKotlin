...
public class RetryAndChangeIpInterceptor implements Interceptor {
    ...
    public RetryAndChangeIpInterceptor(String firstIP, List<String> services) {
        FirstIP = firstIP;
        SERVERS = services;
        RetryCount = 3;
    }

    public RetryAndChangeIpInterceptor(String firstIP, List<String> services, int tryCount) {
        FirstIP = firstIP;
        SERVERS = services;
        RetryCount = tryCount;
    }
