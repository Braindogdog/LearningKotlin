...
public abstract class BaseAdapter<T, iVH extends IViewHolder> extends RecyclerView.Adapter<iVH> {
    ...
    public iVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final iVH iViewHolder = mCreateViewHolder(view);
     ...
     * @return
     */
    protected abstract iVH mCreateViewHolder(View view);
}
