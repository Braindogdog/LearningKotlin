...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_sl_cornerRadius, DensityUtil.dp2px(context,4));
            mShadowRadius = attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius, DensityUtil.dp2px(context,4));
