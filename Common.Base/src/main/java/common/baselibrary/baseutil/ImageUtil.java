...
import common.baselibrary.baseutil.blur.FastBlur;
import common.baselibrary.baseutil.blur.RSBlur;
...
public final class ImageUtil {
     ...
     * @return bitmap
     */
    public static Bitmap drawable2Bitmap(Context context, @DrawableRes int resId) {
    ...
    public static Bitmap stackBlurByRS(Context context, Bitmap src, @IntRange(from = 0, to = 25) int radius) {
        if (src == null) return null;
        return RSBlur.blur(context, src, radius);
    }
