 ...
 * recyclerview中用来实现分组的悬浮分组标题栏
 */
public class GroupItemDecoration extends RecyclerView.ItemDecoration {
    private GetGroupMessageListener mGroupListener;
    /**
     * 悬浮栏高度
     */
    private int mGroupHeight = 64;
    /**
     * 是否靠左边
     */
    private boolean isAlignLeft = true;

    private GroupItemDecoration(GetGroupMessageListener groupListener) {
    ...
    public static class Builder {
        ...
        private Builder(GetGroupMessageListener listener) {
            mDecoration = new GroupItemDecoration(listener);
        }
         ...
         * @return
         */
        public static Builder init(GetGroupMessageListener listener) {
        ...
        public GroupItemDecoration build() {
            return mDecoration;
        }
    }
