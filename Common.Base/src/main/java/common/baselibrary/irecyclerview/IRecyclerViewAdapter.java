...
public class IRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecyclerView.AdapterDataObserver mObserver = new RecyclerView.AdapterDataObserver() {
        ...
        public void onItemRangeChanged(int positionStart, int itemCount) {
            IRecyclerViewAdapter.this.notifyItemRangeChanged(positionStart + 2, itemCount);
        }

        @Override
        public void onItemRangeChanged(int positionStart, int itemCount, Object payload) {
            IRecyclerViewAdapter.this.notifyItemRangeChanged(positionStart + 2, itemCount, payload);
        }

        @Override
        public void onItemRangeInserted(int positionStart, int itemCount) {
            IRecyclerViewAdapter.this.notifyItemRangeInserted(positionStart + 2, itemCount);
        }

        @Override
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            IRecyclerViewAdapter.this.notifyItemRangeRemoved(positionStart + 2, itemCount);
        }
    ...
    public IRecyclerViewAdapter(RecyclerView.Adapter adapter, RefreshHeaderLayout refreshHeaderContainer, LinearLayout headerContainer, LinearLayout footerContainer, FrameLayout loadMoreFooterContainer) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    IRecyclerViewAdapter IRecyclerViewAdapter = (IRecyclerViewAdapter) recyclerView.getAdapter();
                    if (isFullSpanType(IRecyclerViewAdapter.getItemViewType(position))) {
