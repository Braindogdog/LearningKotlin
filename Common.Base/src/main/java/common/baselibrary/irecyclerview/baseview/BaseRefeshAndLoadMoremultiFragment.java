...
import common.baselibrary.baseview.BaseMultiAdapter;
...
public abstract class BaseRefeshAndLoadMoremultiFragment<T> extends BaseFragment {
    protected List<T> listDatas;
    protected IRecyclerView iRecyclerView;
    protected BaseMultiAdapter mAdapter;
    private OnRefreshListener onRefreshListener;
    private OnLoadMoreListener onLoadMoreListener;
    protected int pageIndex = 1;//分页加载页码
    protected int pageNumber = 10;//每页数据数量，当返回数量小于这个数量之后就不再加载更多
