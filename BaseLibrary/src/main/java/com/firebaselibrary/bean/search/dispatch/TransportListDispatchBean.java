 ...
 * 运输资源
 */
public class TransportListDispatchBean  extends BaseDispatchBean{
    /**
     * 名称
     */
     ...
     * 类型
     */
    private String transportCodeName;
    ...
    public String getTransportCodeName() {
        return transportCodeName;
    }

    public void setTransportCodeName(String transportCodeName) {
        this.transportCodeName = transportCodeName;
    }
}
