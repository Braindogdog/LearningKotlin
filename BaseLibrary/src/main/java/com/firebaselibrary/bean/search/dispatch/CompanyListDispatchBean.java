 ...
 * 物资企业
 */
public class CompanyListDispatchBean  extends BaseDispatchBean{
    ...
    public String getCompanyScaleCode() {
        return companyScaleCode;
    }

    public void setCompanyScaleCode(String companyScaleCode) {
        this.companyScaleCode = companyScaleCode;
    }
