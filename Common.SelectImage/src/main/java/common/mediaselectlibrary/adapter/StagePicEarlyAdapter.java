...
public class StagePicEarlyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<EventMedia> infos;


    public StagePicEarlyAdapter(Context context, String alarmId, ArrayList<EventMedia> infos) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.show_item_early, parent, false));
    }
...
//        if(!EmptyUtil.isEmpty(type)&&type.equals("事前")) {
...
//                }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            vImage_early = itemView.findViewById(R.id.vImage_early);
        }
