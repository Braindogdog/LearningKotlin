...
public class StagePicLastAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<EventMedia> infos;


    public StagePicLastAdapter(Context context, String alarmId, ArrayList<EventMedia> infos) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.show_item_last, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(!EmptyUtil.isEmpty(type)&&type.equals("事后")) {
...
//                }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            vImage_early = itemView.findViewById(R.id.vImage_last);
        }
