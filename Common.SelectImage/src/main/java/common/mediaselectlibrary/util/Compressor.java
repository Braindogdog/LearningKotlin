...
/**
 * Created by chasen on 2018/10/31.
 */
...
public class Compressor {//max width and height values of the compressed image is taken as 612x816
    ...
    public File compressToFile(File imageFile, String compressedFileName) throws IOException {
        if (ImageUtil.fileIsExists(destinationDirectoryPath + File.separator + compressedFileName)) {
            return new File(destinationDirectoryPath + File.separator + compressedFileName);
        } else {
