 ...
 */
package common.mediaselectlibrary.mymatisse;
...
import common.mediaselectlibrary.mymatisse.engine.ImageEngine;
import common.mediaselectlibrary.mymatisse.filter.Filter;
import common.mediaselectlibrary.mymatisse.internal.entity.CaptureStrategy;
import common.mediaselectlibrary.mymatisse.internal.entity.SelectionSpec;
import common.mediaselectlibrary.mymatisse.ui.SelfMatisseActivity;
...
public final class SelectionCreator {
     ...
     * 1. {@link common.mediaselectlibrary.mymatisse.engine.impl.GlideEngine}
    ...
    public void forResult(int requestCode) {
        ...
        Intent intent = new Intent(activity, SelfMatisseActivity.class);
