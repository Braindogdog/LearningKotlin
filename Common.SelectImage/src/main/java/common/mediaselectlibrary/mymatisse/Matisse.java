...
public final class Matisse {
    ...
    public static ArrayList<Uri> obtainResult(Intent data) {
        return data.getParcelableArrayListExtra(SelfMatisseActivity.EXTRA_RESULT_SELECTION);
    }
    ...
    public static ArrayList<String> obtainPathResult(Intent data) {
        return data.getStringArrayListExtra(SelfMatisseActivity.EXTRA_RESULT_SELECTION_PATH);
    }
