 ...
 */
package common.mediaselectlibrary.mymatisse.internal.ui.adapter;
...
import common.mediaselectlibrary.mymatisse.internal.entity.IncapableCause;
...
import common.mediaselectlibrary.mymatisse.internal.ui.widget.CheckView;
import common.mediaselectlibrary.mymatisse.internal.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.photo_capture_item_self, parent, false);
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.media_grid_item_self, parent, false);
